...
public:
    ...
    // If not set, defaults to "pdflatex" ("pdflatex.exe" on Windows).
...
rModelIO_EXPORT std::ostream& operator<<( std::ostream& texOutputStream, const PDFGenerator::LaTeXU3DInserter&);
